            ...
            <table rules="none" width="700" align="left" cellspacing="1" >
				...
				?>
						<tr>
                            ...
                            <td align="center" bgcolor= "#a9a9a9" width="100"><a href="edit_af.php?id=<?php echo $data['id']; ?>" class="beli">Edit</a></td>
						    <td align="center" bgcolor= "#a9a9a9" width="100"><a href="delete_af.php?id=<?php echo $data['id']; ?>" class="beli">Delete</a></td>
						</tr>
				<?php
					}
                ?>
