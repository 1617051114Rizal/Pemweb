                ...
                <form action = "proses_beli.php" method = "post" id = "form6">
                    ...
                    <table rules="none" width="500" align="left" cellspacing="1" >
                        ...
                        <tr>
                            ...
                            <td align="center" bgcolor= "#a9a9a9" width="400" height="50px"><input type = "text" name = "Kategori" id = "input" readonly value = "DVD"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align = "center" width="250"><a href="dvd_customer.php" class="beli">Kembali</a></td>
